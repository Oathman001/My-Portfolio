...
title: 'Identity System â€” Founder Brand',
...
overview: [
'This project was about creating a brand identity that feels both personal and professional â€” something that communicates expertise and builds trust at first glance.',
'Working closely with the founder, I developed a complete visual system built around clarity and distinctiveness. Every element â€” from the logo mark to the colour palette â€” was crafted with intention and strategic purpose.',
...
results: [{ num:'100%', label:'Brand Consistency Achieved' },{ num:'3x', label:'Stronger Visual Presence' },{ num:'2 Wks', label:'Time to Full System' },{ num:'âˆž', label:'Scalable Brand Foundation' }],
prev: null, next: 'project-2'
},
'project-2': {
category: 'Social Media Design', year: '2024',
title: 'Content System â€” Creator Brand',
...
'I developed a modular content design system â€” templates, grids, and visual rules â€” that the client could use confidently and consistently without needing to start from scratch every time.',
...
{ title: 'Template System Design', body: 'Built a full set of modular templates in Figma â€” carousel slides, story frames, highlight covers, and post formats â€” all built on a consistent grid.' },
...
results: [{ num:'40+', label:'Templates Delivered' },{ num:'100%', label:'Consistent Brand Voice' },{ num:'2x', label:'Content Production Speed' },{ num:'â†‘', label:'Audience Engagement' }],
prev: 'project-1', next: 'project-3'
},
'project-3': {
category: 'Campaign Concepts', year: '2024',
title: 'Launch Campaign â€” Product Brand',
subtitle: 'Full campaign visual direction and messaging for a product brand\'s market entry â€” from concept to launch-ready creative assets.',
...
'I developed the full campaign concept â€” from the overarching idea and messaging framework to the visual language and key art direction.',
...
{ title: 'Visual Development', body: 'Created key visuals, typography treatments, and the colour story for the campaign â€” building a distinctive visual identity for the launch.' },
{ title: 'Asset Production', body: 'Produced all launch-ready creative assets â€” ad formats, social visuals, and marketing materials â€” ready for immediate deployment.' }
],
results: [{ num:'Day 1', label:'Launch-Ready Delivery' },{ num:'15+', label:'Creative Assets Produced' },{ num:'100%', label:'Brand-Aligned Execution' },{ num:'â†‘', label:'Market Entry Visibility' }],
prev: 'project-2', next: 'project-4'
},
'project-4': {
category: 'Creative Strategy', year: '2024',
title: 'Brand Framework â€” Consultancy',
...
'I worked through a discovery process to understand the firm\'s strengths, target clients, and competitive advantages â€” then translated those insights into a clear, usable brand framework.',
...
results: [{ num:'1 Doc', label:'Complete Strategy Framework' },{ num:'Clear', label:'Brand Positioning Established' },{ num:'5 Pillars', label:'Content Strategy Defined' },{ num:'â†‘', label:'Team Alignment & Confidence' }],
prev: 'project-3', next: 'project-5'
},
'project-5': {
category: 'Brand Identity', year: '2024',
title: 'Visual Direction â€” Startup',
...
overview: [
'At the early stage, a startup needs to look credible and distinctive â€” even before it has a large team or budget. This project was about building that foundation.',
'I focused on creating a tight, well-considered visual system â€” colour palette, typography, and usage rules â€” that would make the startup look polished and professional from day one.',
...
process: [
{ title: 'Brand Direction', body: 'Defined the visual personality â€” modern, trustworthy, and approachable â€” based on the startup\'s values and target audience.' },
...
results: [{ num:'Day 1', label:'Investor-Ready Brand' },{ num:'100%', label:'Visual Consistency' },{ num:'â†‘', label:'Perceived Credibility' },{ num:'WCAG', label:'Accessible Colour System' }],
prev: 'project-4', next: 'project-6'
},
'project-6': {
category: 'Social Media Design', year: '2024',
title: 'Brand Templates â€” Business Owner',
subtitle: 'Reusable content templates and promotional graphics designed for a business owner\'s social media channels â€” built for flexibility and brand consistency.',
...
overview: [
'This business owner was creating content regularly but without a consistent visual system â€” every post looked different, making it hard to build brand recognition.',
'I created a set of flexible, on-brand templates that the owner could use independently â€” without needing design skills â€” while maintaining a professional, cohesive look.',
...
{ title: 'Template Architecture', body: 'Planned a template system covering all key content formats â€” announcements, quotes, promotions, and general posts.' },
...
results: [{ num:'25+', label:'Templates Delivered' },{ num:'3x', label:'Faster Content Creation' },{ num:'100%', label:'Brand Consistency' },{ num:'â†‘', label:'Professional Presence' }],
